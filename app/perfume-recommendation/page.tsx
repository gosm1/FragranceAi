...
Output Format:
Return only an array of 6 recommendations with no introduction or explanation. For each, include:
- The name of the perfume
- The brand
- The price in US dollars
- The 3 top notes of the perfume

Present your recommendations exactly like this:

1. Perfume Name by Brand Name, $XX - (Note 1, Note 2, Note 3)
2. Perfume Name by Brand Name, $XX - (Note 1, Note 2, Note 3)
(Continue for all 6)

Do not include any introductory or summary text—output only the list.`;
